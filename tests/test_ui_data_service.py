...
@pytest.fixture
def mock_report_service(mock_service) -> UIDataService:
    return UIDataService(service=mock_service)

def test_report_total_price_per_day(mock_service: MagicMock, mock_report_service: UIDataService) -> None:
...
def test_report_calculate_avg_sales(mock_service: MagicMock, mock_report_service: UIDataService) -> None:
...
def test_report_sales_trend(mock_service: MagicMock, mock_report_service: UIDataService) -> None:
...
def test_report_detect_outliers(mock_service: MagicMock, mock_report_service: UIDataService) -> None:
